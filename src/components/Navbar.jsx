  ...
  return (
    <nav className="fixed py-4 left-0 right-0 z-50 m2  bg-white ">
      ...
      >
        {/* Left Logo */}
        <a href="#">
          <h1 className="text-neutral-800 text-2xl kanit-light font-bold">
            Lensly
          </h1>
        </a>
        ...
        <div className="">
          <button
            onClick={toggleMenu}
            className="text-neutral-800 text-2xl font-bold focus:outline-none"
      ...
      {isOpen && (
        <div
          className=" max-w-6xl  backdrop-blur-md text-right
                 p-4  mt-2"
        >
          <div className="flex flex-col space-y-4  gap-5">
            <Link
              to="/"
              className="hover:text-black-900 under text-neutral-800"
            >
              Home
            </Link>
            <Link
              to="/gallery"
              className="hover:text-black-800 text-neutral-800"
            >
              Gallery
            </Link>
