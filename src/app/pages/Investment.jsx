...
export default function Investment() {
  return (
    <section className="max-w-7xl p-4 mx-auto">
      <div className="grid grid-cols-1 tracking-tighter gap-4">
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center lg:pt-2 lg:pb-28 gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="text-gray-800  flex flex-col gap-3">
                <li className="flex gap-4 p-4 border border-neutral-200 rounded-lg">
                  <span className="bg-blue-200 w-10 h-10 rounded-lg">
                    <RiCheckFill className="w-6  h-6 mx-auto text-blue-600 mt-2" />{" "}
                  </span>
                  <div>
                    ...
                    <p className="text-gray-500">
                      Easy to manage with our intuitive dashboard and tools
                    </p>
                  </div>
                </li>
                <li className="flex gap-4 p-4 border border-neutral-200 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">
                      Get the best rates on your investments with fintech
                    </p>
                  </div>
                </li>
              </ul>
