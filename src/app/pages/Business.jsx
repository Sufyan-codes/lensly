    ...
    <section className='max-w-6xl mx-auto'>
        ...
        <div className="flex flex-col gap-4">
          ...
          <ul className="text-gray-800 lg:text-xl flex flex-col gap-3">
            <li><span className="bg-blue-200 w-10 h-10 rounded-md">img</span> Bill Payments, Funds Transfer, QR payments.</li>
            <li><span className="bg-blue-200 w-10 h-10 rounded-md">img</span> Credit card payments and order food.</li>
          </ul>
        </div>
        <img src={hero} alt="" />
      </div>
