      ...
      <div>
        ...
        <div className="px-4">
          ...
          <div className="md:flex gap-10 mt-4">
            ...
            <div className="flex gap-4">
              <div className="bg-blue-200 w-10 h-10 rounded-md mx-auto"><RiShieldLine className="w-6  h-6 mx-auto text-blue-600 mt-2"/></div>
              <div className="flex flex-col gap-1">
                <p className="lg:text-xl font-semibold text-neutral-600">
                  Secure Banking
                </p>
          ...
          <div className="mt-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div className="flex flex-col gap-4 bg-white shadow p-5 rounded-lg">
              <div className="bg-blue-200 w-10 h-10 rounded-md"><RiShieldLine className="w-6  h-6 mx-auto text-blue-600 mt-2"/></div>
            ...
            <div className="flex flex-col gap-4 bg-white shadow p-5 rounded-lg">
              <div className="bg-blue-200 w-10 h-10 rounded-md"><RiArrowRightLine className="w-6  h-6 mx-auto text-blue-600 mt-2"/></div>
